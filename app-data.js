export const services = {
  ops: {
    en: { title: "BUSINESS OPERATIONS", icon: '<i class="fa-thin fa-briefcase"></i>',
  ...
  cc: {
    en: { title: "CONTACT CENTER", icon: '<i class="fa-thin fa-headset"></i>',
    ...
    es: { title: "CENTRO DE CONTACTO", icon: '<i class="fa-thin fa-headset"></i>',
  ...
  it: {
    en: { title: "IT SUPPORT", icon: '<i class="fa-thin fa-laptop-code"></i>',
    ...
    es: { title: "SOPORTE IT", icon: '<i class="fa-thin fa-laptop-code"></i>',
  ...
  pro: {
    en: { title: "PROFESSIONALS", icon: '<i class="fa-thin fa-user-tie"></i>',
    ...
    es: { title: "PROFESIONALES", icon: '<i class="fa-thin fa-user-tie"></i>',
